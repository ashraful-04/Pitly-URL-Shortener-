        ...
        <div className="card">
          <section className="font-bold space-y-10">
            <h2 className="text-2xl">
              ...
              {shortId && (
                <a
                  href={`${import.meta.env.VITE_BASE_URL}/${shortId}`}
                  target="_blank"
          ...
          <section>
            ...
            >
              <input
                className="my-1 p-1 border border-light-border rounded-md w-full h-10 mb-1"
                type="text"
                value={url}
          ...
          <section className="hero font-bold"></section>
        </div>
      </section>
    </div>
  );
